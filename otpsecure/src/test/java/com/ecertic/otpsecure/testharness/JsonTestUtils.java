package com.ecertic.otpsecure.testharness;
...
public class JsonTestUtils {
     ...
     * @param second the second object
     */
    private static void assertJsonEqualsExcludingNulls(JSONObject first, JSONObject second) {
        if (assertSameNullity(first, second)) {
            return;
        }
     ...
     */
    private static boolean assertSameNullity(Object first, Object second) {
